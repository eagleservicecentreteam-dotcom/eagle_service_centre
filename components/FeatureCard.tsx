...
const FeatureCard = ({
  ...
  return (
    <div ref={cardRef} className="relative flex flex-col items-start justify-start md:items-start md:justify-start gap-[16px] md:gap-[32px] bg-[#F3F3F3] rounded-[32px] px-[24px] py-[24px] md:py-[32px] md:px-[24px] lg:py-[40px] lg:px-[32px] min-w-[200px] md:min-w-0">
