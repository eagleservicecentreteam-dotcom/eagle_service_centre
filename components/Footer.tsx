  ...
  return (
    <footer className="bg-black flex flex-col gap-6 md:gap-12 px-4 py-10 md:px-8 md:py-5 lg:px-20 font-geist">
      ...
      <div className="flex-1 w-full flex flex-col md:flex-row items-start md:items-center justify-between gap-10 md:gap-0">
        ...
        <div className="flex flex-col w-full justify-between gap-10">
          <div className="flex items-center justify-start gap-2">
            ...
            <div className="flex flex-col leading-tight">
              <h1 className="font-serif font-bold italic text-lg md:text-[26px] text-blue-600">
        ...
        <div className="flex flex-col gap-2 items-start md:items-end w-full md:w-auto text-left lg:mt-12">
          {[
            "Monday",
            "Tuesday",
            "Wednesday",
            ...
            <p
              key={day}
              className="flex justify-between w-full md:w-52 text-lg"
            >
              <span className="font-light text-[#c7c7c7]">{day}</span>
              <span className="ml-4 font-light text-[#c7c7c7]">
                {day !== "Sunday" ? "10am - 7pm" : "Closed"}
              </span>
            </p>
          ))}
        </div>
